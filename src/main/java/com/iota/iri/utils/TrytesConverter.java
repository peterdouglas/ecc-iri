...
public class TrytesConverter {
    ...
    public static String toTrytes(String inputString) {
        ...
        for (int i = 0; i < inputString.length(); i++) {
            ...
            String trytesValue = String.valueOf(Converter.TRYTE_ALPHABET.charAt(firstValue) + String.valueOf(Converter.TRYTE_ALPHABET.charAt(secondValue)));
    ...
    public static String toString(String inputTrytes) {
        ...
        for (int i = 0; i < inputTrytes.length(); i += 2) {
            ...
            int firstValue = Converter.TRYTE_ALPHABET.indexOf(inputTrytes.charAt(i));
            int secondValue = Converter.TRYTE_ALPHABET.indexOf(inputTrytes.charAt(i + 1));
