...
public class TransactionViewModel {
    ...
    public static final int VALUE_TRINARY_OFFSET = VECTORP_TRINARY_OFFSET + VECTORP_TRINARY_SIZE, VALUE_TRINARY_SIZE = 1110;
    public static final int RANGEPROOF_TRINARY_OFFSET = VALUE_TRINARY_OFFSET + VALUE_TRINARY_SIZE, RANGEPROOF_TRINARY_SIZE = 8250;
