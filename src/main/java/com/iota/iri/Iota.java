...
public class Iota {
    ...
    public static final String MAINNET_COORDINATOR_ADDRESS = "HJIWVLNGFJH9YER9MVR9GM99VOFURCNYAPHQODMGLVCNZAIHCSONLYQRYRUUWJJUYKWCVIYOB9OPNNDD9";
    public static final Hash MAINNET_COORDINATOR = new Hash(MAINNET_COORDINATOR_ADDRESS);
    public static final String TESTNET_COORDINATOR_ADDRESS = "HJIWVLNGFJH9YER9MVR9GM99VOFURCNYAPHQODMGLVCNZAIHCSONLYQRYRUUWJJUYKWCVIYOB9OPNNDD9";
