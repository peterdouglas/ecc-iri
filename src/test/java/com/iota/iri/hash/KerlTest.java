...
public class KerlTest {
    ...
    public void bytesFromBigInt() throws Exception {
        int byte_size = 48;
        BigInteger bigInteger = new BigInteger("13190295509826622394583200125168488859623001289643321872497025844241981297292953903419783680940401133507992851240799");
